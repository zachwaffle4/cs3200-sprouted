...
def get_dashboard_data(food_bank_id, season="2026", compare_to="2025"):
    try:
        ...
        r_months = requests.get(
            f"{API_BASE}/analytics/donations-by-month", params={"org_id": food_bank_id}
        )
        r_sites = requests.get(
            f"{API_BASE}/analytics/top-sites", params={"org_id": food_bank_id}
        )
