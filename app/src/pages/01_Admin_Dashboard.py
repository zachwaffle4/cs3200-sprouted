...
def api_get(path, params=None):
    try:
        # Some endpoints might not have /api prefix if they are already in API_BASE
        # but let's be consistent with how other pages do it.
        # Actually other pages use f"{API_BASE}/..."
        url = f"{API_BASE}{path}"
